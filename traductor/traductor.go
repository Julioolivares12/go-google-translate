...
retorna un struct con los datos de la traduccion
*/ 
...
//devuelve un struct de tipo AutoGenerated

func obtenerTraduccion(link string, q string, tl string, sl string) (AutoGenerated, error) {
	dataForm := url.Values{
		"sl": {sl},
		"tl": {tl},
		"q":  {q},
